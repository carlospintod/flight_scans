    ...
    <div className="max-w-3xl space-y-10">
      <section className="space-y-3">
        ...
        <p className="leading-relaxed">
          ...
          for a running cost of <span className="text-good">€0/month</span>.
        </p>
      </section>
      ...
      <section>
        ...
        <Card className="font-mono text-[13px] leading-7">
          <ol className="list-inside list-decimal space-y-1 text-text">
            <li>
              A <span className="text-cyan99">GitHub Actions</span> cron job
            ...
            <li>
              ...
              lands in a <span className="text-cyan99">Turso</span> database
            ...
            <li>
              ...
              <span className="text-cyan99">ntfy.sh</span>.
            </li>
            <li>
            ...
            <tbody>
              {SOURCES.map(([name, budget, role]) => (
                <tr key={name} className="border-b border-border align-top">
                  <td className="py-2 pr-4 whitespace-nowrap text-text-bright">
                    {name}
                  </td>
                  <td className="py-2 pr-4 whitespace-nowrap text-good">
                    {budget}
                  </td>
                  <td className="py-2 text-text">{role}</td>
                </tr>
              ))}
            </tbody>
          </table>
